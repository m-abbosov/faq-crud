...
async function loadFAQs() {
  try {
    ...
    if (result.success) {
      ...
      showMessage(
        result.error || 'FAQlarni yuklashda xatolik yuz berdi',
        'error'
      );
    }
  } catch (error) {
...
async function createFAQ(faqData) {
  try {
    ...
    if (result.success) {
      ...
      showMessage(result.error || "FAQ qo'shishda xatolik", 'error');
      return false;
    }
  } catch (error) {
...
async function updateFAQ(id, faqData) {
  try {
    ...
    if (result.success) {
      ...
      showMessage(result.error || 'FAQ yangilashda xatolik', 'error');
      return false;
    }
  } catch (error) {
...
async function deleteFAQ(id) {
  try {
    ...
    if (result.success) {
      ...
      showMessage(result.error || "FAQ o'chirishda xatolik", 'error');
      return false;
    }
  } catch (error) {
                    ...
                    <div class="faq-date">
                        ...
                        ${
                          faq.updatedAt !== faq.createdAt
                            ? `<br>Yangilangan: ${formatDate(faq.updatedAt)}`
                            : ''
                        }
                    </div>
                    <div class="faq-actions">
                        <button class="btn btn-edit" onclick="editFAQ('${
                          faq.id
                        }')">
...
function toggleFAQ(id) {
  ...
  const toggleIcon =
    answerElement.previousElementSibling.querySelector('.faq-toggle');
